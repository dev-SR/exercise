...
int main() {
    ...
    Zone zones[] = {
        {.id = 1, .low = 0, .str = "rest"},
        {.id = 2, .low = 0.5, .str = CYN "very light, active recovery" NC},
        {.id = 3, .low = 0.6, .str = BLU "light, cardio training, improves your general endurance" NC},
        {.id = 4, .low = 0.7, .str = GRN "moderate, aerobic fitness, improve your efficiency" NC},
        {.id = 5, .low = 0.8, .str = YEL "hard, raise the anaerobic threshold, improve your speed endurance" NC},
        {.id = 6, .low = 0.9, .str = RED "peak performance, improve your power, only for pros!" NC},
    };
