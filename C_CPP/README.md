...
<tbody>
  <tr>
    <td><code>defc</code></td>
    <td>define a new class in a header file</td>
  </tr>
</tbody>
</table>
...
```json
 "define_header": {
  ...
  "body": [
   ...
   "    $3",
   "};",
   "#endif // MACRO_${1:${TM_FILENAME_BASE/(.*)/${1:/upcase}/}}_H",
   "",
   ""
  ],
  "description": "define a new class in a header file"
 }
```
